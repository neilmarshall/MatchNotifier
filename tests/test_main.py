...
class MainTestCase(unittest.TestCase):
    ...
    def test_get_timeout(self, mock_datetime):
        mock_datetime.return_value = datetime(2021, 9, 5, 17, 30, tzinfo=gettz('BST'))
        mock_datetime.now = lambda _: datetime(2021, 9, 5, 8, 30, tzinfo=gettz('BST'))
        self.assertEqual(get_timeout(2021, 9, 5, 17, 30), (17 - 1 - 8) * 60 * 60)
